...
from Alexia.__main__ import STATS, TOKEN, USER_INFO
from Alexia.modules.sql import SESSION
import Alexia.modules.sql.userinfo_sql as sql
from Alexia.modules.disable import DisableAbleCommandHandler
from Alexia.modules.sql.global_bans_sql import is_user_gbanned
from Alexia.modules.sql.afk_sql import is_afk, set_afk
from Alexia.modules.sql.users_sql import get_user_num_chats
from Alexia.modules.helper_funcs.chat_status import sudo_plus
from Alexia.modules.helper_funcs.extraction import extract_user
from Alexia import telethn
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        disaster_level_present = True
         ...
         text += "\n\nOwner Of A Bot. Queen Of @Saur12p. Bot Name Inspired From 'Lydia'."
         disaster_level_present = True
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                "Health", url="https://t.me/ALEXIA_UPDATE"),
                            InlineKeyboardButton(
                                "Disaster", url="https://t.me/ALEXIA_UPDATE")
                        ],
                    ]
                ),
                parse_mode=ParseMode.HTML,
...
def stats(update: Update, context: CallbackContext):
    ...
    result += "\n<b>╘═━「 Powered By [Alexia](https://github.com/Sumans11」</b>"
    update.effective_message.reply_text(
        result,
        parse_mode=ParseMode.HTML, 
        disable_web_page_preview=True
