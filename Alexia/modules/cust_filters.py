...
from Alexia import dispatcher, LOGGER, DRAGONS
from Alexia.modules.disable import DisableAbleCommandHandler
from Alexia.modules.helper_funcs.handlers import MessageHandlerChecker
from Alexia.modules.helper_funcs.chat_status import user_admin
from Alexia.modules.helper_funcs.extraction import extract_text
from Alexia.modules.helper_funcs.filters import CustomFilters
from Alexia.modules.helper_funcs.misc import build_keyboard_parser
from Alexia.modules.helper_funcs.msg_types import get_filter_type
from Alexia.modules.helper_funcs.string_handling import (
    split_quotes,
    button_markdown_parser,
    escape_invalid_curly_brackets,
    markdown_to_html,
)
from Alexia.modules.sql import cust_filters_sql as sql
...
__help__ = """
𒊹︎ /filters - `List all active filters saved in the chat.`

*Admin Commands Only:*

𒊹︎ /filter - `Add a filter to this chat. The bot will now reply that message whenever 'keyword'\`
...
𒊹︎ /stop - `Stop that filter.`

*Chat Creator Only:*

𒊹︎ /removeallfilters - `Remove all chat filters at once.`
