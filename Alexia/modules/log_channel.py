...
from Alexia.modules.helper_funcs.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from Alexia import EVENT_LOGS, LOGGER, dispatcher
    from Alexia.modules.helper_funcs.chat_status import user_admin
    from Alexia.modules.sql import log_channel_sql as sql
...
𒊹︎  /logchannel - `get log channel info`

𒊹︎  /setlog - `set the log channel.`

𒊹︎  /unsetlog - `unset the log channel.`
