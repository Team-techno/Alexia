...
from Alexia import OWNER_ID, SUPPORT_CHAT
...
async def lego(event):
 ...
 try:
    ...
    fillcolor = "black"
    shadowcolor = "blue"
    fnt = glob.glob("./Alexia/resources/fonts/*")
    ...
    await telethn.send_file(event.chat_id, file=fname, caption = f"Made by [Techno🌸](t.me/Technobotsupport)")
    await pesan.delete()
