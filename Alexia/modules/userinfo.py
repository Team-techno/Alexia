...
from Alexia.modules.sql.afk_sql import is_afk, check_afk_status
...
from Alexia import telethn as YoneTelethonClient, TIGERS, DRAGONS, DEMONS
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' [<a href="https://t.me/ALEXIA_UPDATE">?</a>]'.format(
            bot.username
        )
