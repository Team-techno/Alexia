                    ...
                    [
                        [
                            InlineKeyboardButton(
                                "Health", url="https://t.me/AlexiaLogger/5"),
                            InlineKeyboardButton(
                                "Disaster", url="https://t.me/AlexiaLogger/6")
                        ],
                    ]
                ),
                parse_mode=ParseMode.HTML,
...
def stats(update: Update, context: CallbackContext):
    stats = "<b>╔═━「 Current Alexia's Statistics 」</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
...
*What is that health thingy?*
 ...
 `Come and see` [HP System explained](https://t.me/AlexiaLogger/5)
