...
import Alexia.modules.sql.blacklist_sql as sql
from Alexia import dispatcher, LOGGER
from Alexia.modules.disable import DisableAbleCommandHandler
from Alexia.modules.helper_funcs.chat_status import user_admin, user_not_admin
from Alexia.modules.helper_funcs.extraction import extract_text
from Alexia.modules.helper_funcs.misc import split_message
from Alexia.modules.log_channel import loggable
from Alexia.modules.warns import warn
from Alexia.modules.helper_funcs.string_handling import extract_time
from Alexia.modules.connection import connected
from Alexia.modules.sql.approve_sql import is_approved
from Alexia.modules.helper_funcs.alternate import send_message, typing_action
...
𒊹︎ /blacklist - `View the current blacklisted words.`

Admin only:

𒊹︎ /addblacklist - `<triggers> Add a trigger to the blacklist. Each line is considered one trigger, so using different lines will allow you to add multiple triggers.`

𒊹︎ /unblacklist - `<triggers> Remove triggers from the blacklist. Same newline logic applies here, so you can remove multiple triggers at once.`

𒊹︎ /blacklistmode - `<off/del/warn/ban/kick/mute/tban/tmute> Action to perform when someone sends blacklisted words.`

*Blacklist sticker is used to stop certain stickers. Whenever a sticker is sent, the message will be deleted immediately.*

*NOTE:* `Blacklist stickers do not affect the group admin`
𒊹︎ /blsticker - `See current blacklisted sticker`

*Only admin:*

𒊹︎ /addblsticker - `<sticker link> Add the sticker trigger to the black list. Can be added via reply sticker`

𒊹︎ /unblsticker - `<sticker link> Remove triggers from blacklist. The same newline logic applies here, so you can delete multiple triggers at once`

𒊹︎ /rmblsticker - `<sticker link> Same as above`

𒊹︎ /blstickermode - `<delete/ban/tban/mute/tmute> sets up a default action on what to do if users use blacklisted stickers`

Note:

𒊹︎ *<sticker link> can be* `https://t.me/addstickers/<sticker>` *or just* `<sticker>` *or reply to the sticker message*
