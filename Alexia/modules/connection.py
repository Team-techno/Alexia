...
import Alexia.modules.sql.connection_sql as sql
from Alexia import dispatcher, DRAGONS, DEV_USERS
from Alexia.modules.helper_funcs import chat_status
...
𒊹︎ /connect - `Connects to chat (Can be done in a group by /connect or /connect <chat id> in PM)`

𒊹︎ /connection - `List connected chats`

𒊹︎ /disconnect - `Disconnect from a chat`

𒊹︎ /helpconnect - `List available commands that can be used remotely`

*Admins only:*

𒊹︎ /allowconnect - `<yes/no> allow a user to connect to a chat`
