...
from Alexia import pbot as app 
from Alexia import arq
from Alexia.services.keyboard import Ikb
from Alexia.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from Alexia.services.tasks import _get_tasks_text, all_tasks, rm_task
from Alexia.services.types import InlineQueryResultCachedDocument
from Alexia.modules.info import get_chat_info, get_user_info
from Alexia.modules.music import download_youtube_audio
from Alexia.utils.functions import test_speedtest
from Alexia.utils.pastebin import paste
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/8e5af90e239532a9c35a4.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Add me", url="http://t.me/Alexia_Robot?startgroup=true"),
        InlineKeyboardButton(
    ...
    msg = f"""
**[Alexia_Robot 🤩](https://t.me/ALEXIA_SUPPORT):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [Updates](t.me/ALEXIA_UPDATE)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
